...
import barakat.app.aggregator.entity.app.repository.mirrorgen.RegweightsTcRepository;
import barakat.app.aggregator.entity.tctransport.repository.gen.RegweightsRepository;
...
public class RegweightsShedule implements TcTransportCopySchedule {
    @Autowired
    RegweightsRepository repository;
    @Autowired
